...
class RestaurantTest {
    ...
    @BeforeEach
    public void setup_restaurant(){
        LocalTime openingTime = LocalTime.parse("10:30:00");
        LocalTime closingTime = LocalTime.parse("22:00:00");
        restaurant = new Restaurant("Amelie's cafe","Chennai",openingTime,closingTime);
        restaurant.addToMenu("Sweet corn soup",119);
        restaurant.addToMenu("Vegetable lasagne", 269);
        restaurant.addToMenu("Nimbu Pani", 50);
        restaurant.addToMenu("Coke", 50);
    }
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        //spy object and mock getCurrentTime() to 20 minutes before the closingTime
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        ...
        restaurant = Mockito.spy(restaurant);
        //spy object and mock getCurrentTime() to 20 minutes after the closingTime
        Mockito.when(restaurant.getCurrentTime()).thenReturn(restaurant.closingTime.plusMinutes(20));
        Boolean restaurantStatus = restaurant.isRestaurantOpen();
